...
df = d |> 
  ...
  slice(rep(1:n(), each=reps))|> #allows you to change dataset, you can use it to subset or make things longer (like in this case). Use this slice function to create a repeat of every single line for the number of reps you want (in this case 50)
